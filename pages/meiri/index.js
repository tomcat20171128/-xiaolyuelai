...
Page({
  ...
  onLoad: function () {
    ...
    date=mydate.getDate();
    console.log(111,"date"+date)
    var day=mydate.getDay();
    console.log(222,day)
    var nbsp=7-((date-day)%7);
    console.log(333,"nbsp"+nbsp);
    var monthDaySize;
    ...
    console.log(444,calendarSignData);
    console.log(555,calendarSignDay)
    this.setData({
        year:year,
        month:month,
        nbsp:nbsp,
